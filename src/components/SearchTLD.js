    ...
    <div className="tldcomponent">
      ...
      <div className="search-container">
        ...
        <button onClick={handleSearch}>
          <svg width="24" height="24" viewBox="0 0 24 24"><path fill="#111" d="M15.7 14.3h-.79l-.28-.27a6.5 6.5 0 1 0-.91.91l.27.28v.79l5 4.99 1.49-1.49-4.99-5zm-6.2 0A4.8 4.8 0 1 1 14.3 9.5a4.8 4.8 0 0 1-4.8 4.8z"/></svg>
        </button>
      </div>
